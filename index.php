            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row" id="productsList">
                        ...
                        ?>
                            <div class="col-md-6 mb-3 product-item" data-name="<?php echo strtolower($product['product_name']); ?>"
                    ...
                    <div style="max-height: 40vh; overflow-y: auto;" class="mb-4">
                        ...
                        <?php else: ?>
                            ...
                            foreach ($_SESSION['cart'] as $item):
                                ...
                                $subtotal += $item_total;
                            ?>
                                <div class="billing-item row align-items-center g-2">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <form method="POST" class="d-flex w-100">
                                                ...
                                                <input type="number" name="quantity"
                                                    ...
                                                    min="1" class="quantity-input mx-1"
                                    ...
                                    <div class="col-5 col-md-3 text-end">
                                        <div class="d-flex flex-column align-items-end">
                                            <small class="d-md-inline d-none">₹<?php echo number_format($item['price'], 2); ?> × <?php echo $item['quantity']; ?></small>
